...
def generate_thumbs(file: Path, max_size=(520, 520), output_file: Path = None):
    """生成缩略图"""
    ...
    with Image.open(file) as img:
        ...
        # ​​WEBP​​：范围 0-100（默认 80）。
        # ​​method​​（仅适用于有损压缩格式）：6：最慢，但压缩率最高，文件最小
        # ​​lossless​​（适用于无损压缩格式）：True：无损压缩，False：有损压缩
        img.save(output_file, format="WEBP", quality=85, method=6, lossless=False)
