...
WECHAT_XPAY_APPID = config("WECHAT_XPAY_APPID")
WECHAT_XPAY_OFFER_ID = config("WECHAT_XPAY_OFFER_ID")
WECHAT_XPAY_APPKEY = config("WECHAT_XPAY_APPKEY")
WECHAT_XPAY_SANDBOX_APPKEY = config("WECHAT_XPAY_SANDBOX_APPKEY")
...
NGINX_MEDIA_URL = "https://api.wp.ego8.space/media" if ENV == "prod" else "http://127.0.0.1:8000/media"
